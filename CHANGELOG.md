...
- Added `docs/ROADMAP.md` to capture future detail-mode and TMATS-output direction.
...
- Redesigned the default CLI output into a left-aligned summary plus a single consolidated channel/data-type table.
- Moved verbose packet listing to the end of the output after the default summary.
...
- Removed the verbose TMATS warning block from the default output while keeping a simple TMATS status line.
